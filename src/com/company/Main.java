...
//        System.out.println(gunSprays.getSprays("LR-300"));
        while (true) {
            ...
            if (input.equalsIgnoreCase("create account")){
                ...
                System.out.println("This is your id! " + userID + " Please do not forget this!");
                Connect.createNewUser(userID, username);
                ...
                keyboard.nextLine();
                String userCheck = Connect.getUserName(id);
                if (userCheck!=null){
                    System.out.println("Hi there " + userCheck + "!");
                    while (true) {
                        input = mainMenu();
